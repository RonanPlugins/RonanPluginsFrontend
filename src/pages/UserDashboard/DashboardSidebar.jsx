...
const LinkItems = [
  ...
  { name: "Downloads", icon: FiDownload, url: "/user/downloads" },
  { name: "License", icon: FiTag, url: "/user/license" },
  { name: "Subscription", icon: FiCreditCard, url: "/user/subscription" },
  { name: "Settings", icon: FiSettings, url: "/user/settings" },
]
